...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#060613] text-gray-100">
      {/* HEADER */}
      <header className="bg-[#0b0b20] border-b border-[#1e1e38] px-4 py-4 text-center">
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 0%, #111135 0%, #060613 70%)",
        }}
      >
        <div
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-base text-gray-400 max-w-xl mx-auto mb-8 font-dm font-light leading-relaxed">
            Access high-tier fixed APY configurations built on verified
            risk-mitigation frameworks. Manage digital crypto assets with
        ...
        <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
          {[
            ...
            >
              <div className="font-syne text-lg font-bold text-[#e2e8f0]">
                {stat.val}
              </div>
      ...
      <section
        id="how-it-works"
        className="max-w-5xl mx-auto py-16 px-4 border-t border-[#1e1e38]/40"
      >
        <h2 className="text-center font-syne text-2xl sm:text-3xl font-bold mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {STEPS.map((step) => (
            <div
              key={step.num}
              className="bg-[#0f0f30]/40 p-6 rounded-xl border border-[#1e1e38]/30"
            >
              <div className="text-2xl font-bold text-[#e2e8f0]/30 font-syne mb-3">
                {step.num}
              </div>
      ...
      >
        ...
        <p className="text-center text-sm text-gray-400 mb-10 max-w-md mx-auto">
          Choose a baseline capital configuration tier. Yield settlements
          processed every Sunday.
        </p>
          ...
          {PLANS.map((plan) => (
            ...
            >
              <div>
                ...
                <div className="text-2xl font-bold mb-3 font-syne text-[#e2e8f0]">
                  {plan.apy} APY
                </div>
                ...
                <ul className="space-y-2 mb-5">
                  {plan.perks.map((p) => (
                    ...
                    >
                      <span className="text-[#e2e8f0] mt-0.5 flex-shrink-0">
                        ✓
                      </span>
                      {p}
                    </li>
      ...
      >
        ...
        <p className="text-center text-sm text-gray-400 mb-3 max-w-xl mx-auto">
          Maintain active capital placements in the Amateur Growth tier or above
          to instantly unlock dollar-denominated liquidity facilities.
        </p>
        <p className="text-center text-xs text-gray-500 mb-10 max-w-lg mx-auto">
          Risk/Credit Notice: All credit lines are backed safely 1:1 against
          your cold custody ledger balances.
        </p>
      ...
      <section
        id="calculator"
        className="max-w-lg mx-auto py-16 px-4 border-t border-[#1e1e38]/40"
      >
        <h2 className="text-center font-syne text-2xl sm:text-3xl font-bold mb-2">
          ...
          {result && (
            <div className="grid grid-cols-3 gap-3 pt-1">
              {[
                ...
                {
                  label: "Annual",
                  val: `$${result.projected_annual.toFixed(2)}`,
                },
              ].map((item) => (
                <div
                  key={item.label}
                  className="bg-[#060613] border border-[#1e1e38] rounded-lg p-3 text-center"
                >
                  <div className="font-syne text-base font-bold text-[#e2e8f0]">
                    {item.val}
                  </div>
        ...
        <div className="bg-[#0f0f30] border border-[#1e1e38] rounded-xl overflow-hidden">
          {FEES.map((fee, i) => (
            ...
            >
              ...
              <span className="font-syne font-bold text-[#e2e8f0] flex-shrink-0">
                {fee.value}
              </span>
            </div>
          ))}
      ...
      >
        ...
        <p className="text-center text-sm text-gray-400 mb-10 max-w-xl mx-auto">
          Apex manages pool parameters using deep encryption layers and strict
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={item.title}
              className="bg-[#0f0f30]/40 border border-[#1e1e38]/30 rounded-xl p-5"
            >
              <h3 className="font-syne font-bold text-base mb-2 text-[#e2e8f0]">
                {item.title}
              </h3>
      ...
      >
        ...
        <form
          ...
          className="bg-[#0f0f30] border border-[#1e1e38] rounded-xl p-6 space-y-5"
        >
          <div>
            <label className="block text-xs text-gray-400 uppercase tracking-widest mb-2">
              Legal Full Name
          ...
          {formStatus && (
            <p className="text-sm text-center text-[#e2e8f0] mt-2">
              {formStatus}
            </p>
          )}
        </form>
      ...
      <footer className="border-t border-[#1e1e38] py-8 text-center text-xs text-gray-600 px-4">
        <p className="mb-2 font-syne tracking-widest uppercase text-gray-500">
          Apex Asset Management — APX-2026
        </p>
        <p className="max-w-md mx-auto leading-relaxed">
          Apex operates as a closed private template execution interface. Past
          performance frameworks do not guarantee identical ledger yields.
        </p>
      </footer>
    </div>
  );
